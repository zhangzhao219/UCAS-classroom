...
def postclass(weekname,weekday_name):
...
def sendEmail(weeknum,weekday,fromaddr,password,toaddrs):
    ...
    pdfApart.add_header('Content-Disposition', 'attachment', filename=pdfFile.split('/')[-1])
...
if __name__ == '__main__':
    ...
    postclass(weeknum,weekdaylist[nowdate.weekday()])
